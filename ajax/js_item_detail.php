...
<?if($arPost["PARAMS"]):?>
	...
	else
	{
		...
		if(isset($arPost["PARAMS"]["SKU_STORES"]) && $arPost["PARAMS"]["SKU_STORES"]){
			$arFilter["PROPERTY_".Aspro\Max\Stores\Property::getStoresFilterPropCode()] = $arPost["PARAMS"]["SKU_STORES"];
		}
