...
$APPLICATION->SetPageProperty("description", "Условия возврата и обмена военных товаров, обязательства Военторга. Гарантийный срок армейского обмундирования, купленного в магазине Полигон.");
$APPLICATION->SetPageProperty("title", "Гарантия на товары магазина Полигон");
