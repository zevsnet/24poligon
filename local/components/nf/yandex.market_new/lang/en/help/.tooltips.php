...
$MESS ['IBLOCK_ID_IN'] = "The Filter for inclusion on ID and (or) to a mnemonic code of the information block. As parametre can be as individual value (ID or a mnemonic code of the information block), and a file (array) such values. Unessential. All elements from information blocks of type type without an additional filtration by default join.";
$MESS ['IBLOCK_ID_EX'] = "The Filter for an exception on ID and (or) to a mnemonic code of the information block. As parametre can be as individual value (ID or a mnemonic code of the information block), and a file (array) such values. Unessential. All elements by default get out of information blocks of type type bar none.";
