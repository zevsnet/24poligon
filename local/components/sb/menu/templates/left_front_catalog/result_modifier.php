...
$arSections = COptimusCache::CIBlockSection_GetList(
    array(
        ...
        'CACHE' => array('TAG' => COptimusCache::GetIBlockCacheTag($catalog_id), 'GROUP' => array('ID'))
    ),
    array(
    ...
    false,
    array("ID", "NAME",'SORT', "PICTURE", "LEFT_MARGIN", "RIGHT_MARGIN", "DEPTH_LEVEL", "SECTION_PAGE_URL", "IBLOCK_SECTION_ID"));
if ($arSections) {
    $arResult = array();
