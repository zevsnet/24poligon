...
<tr>
    <td width="50%">
        <span id="hint_PROFILE[SETUP][VALIDATE_CONDITIONS]"></span><script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[SETUP][VALIDATE_CONDITIONS]' ), '<?=GetMessage( "ACRIT_EXPORTPRO_SETUP_VALIDATE_CONDITIONS_HELP" )?>' );</script>
        <label for="PROFILE[SETUP][VALIDATE_CONDITIONS]"><?=GetMessage( "ACRIT_EXPORTPRO_SETUP_VALIDATE_CONDITIONS" )?></label>
    </td>
...
<tr class="heading" align="center">
    <td colspan="2"><?=GetMessage( "ACRIT_EXPORTPRO_FIELDSET_ADDITIONAL_SETTINGS_HEADER" )?></td>
</tr>
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
				<?=GetMessage( "ACRIT_EXPORTPRO_FIELDSET_ADDITIONAL_SETTINGS_SKU_USE_CANONICAL" )?>
		</td>
...
<tr>
    <td width="50%" class="adm-detail-content-cell-l">
				...
				<script type="text/javascript">BX.hint_replace( BX( 'hint_PROFILE[OFFER_WITH_SKU_USE_QUANTITY]' ), '<?=GetMessage( "ACRIT_EXPORTPRO_FIELDSET_ADDITIONAL_SETTINGS_OFFER_WITH_SKU_USE_QUANTITY_HINT" )?>' );</script>
				<?=GetMessage( "ACRIT_EXPORTPRO_FIELDSET_ADDITIONAL_SETTINGS_OFFER_WITH_SKU_USE_QUANTITY" )?>
		</td>
    <td width="50%" class="adm-detail-content-cell-r">
