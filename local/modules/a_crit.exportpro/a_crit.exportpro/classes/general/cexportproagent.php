...
class CExportproAgent{
    private static $moduleId = "a_crit.exportpro";
    ...
    public static function StartExport( $profileId, $cronSetupId, $bTmpAgent = false ){
        ...
        if( file_exists( $_SERVER["DOCUMENT_ROOT"]."/local/tools/".self::$moduleId."/export_{$profileId}_run.lock" ) ){
            return $returnRow;
        }
    ...
    public static function AddAgent( $profileId, $cronSetupIdPreset = false ){
        ...
        if( file_exists( $_SERVER["DOCUMENT_ROOT"]."/bitrix/crontab/crontab.cfg" ) ){
            ...
            $cronTask = "* * * * * {$taskMode} {$_SERVER["DOCUMENT_ROOT"]}/local/modules/".self::$moduleId."/tools/cron_events.php";
