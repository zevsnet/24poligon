    ...
    public static function GetLogic($arOperators = false)
    {
        $arOperatorsList = array(
            ...
            BT_COND_LOGIC_GR => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# > #VALUE#',
                    'Y' => 'CAcritGlobalCondCtrl::LogicGreat(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'Great',
            ...
            BT_COND_LOGIC_LS => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# < #VALUE#',
                    'Y' => 'CAcritGlobalCondCtrl::LogicLess(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'Less',
            ...
            BT_COND_LOGIC_EGR => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# >= #VALUE#',
                    'Y' => 'CAcritGlobalCondCtrl::LogicEqualGreat(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'EqGr',
            ...
            BT_COND_LOGIC_ELS => array(
                ...
                'OP' => array(
                    'N' => '#FIELD# <= #VALUE#',
                    'Y' => 'CAcritGlobalCondCtrl::LogicEqualLess(#FIELD#, #VALUE#)'
                ),
                'VALUE' => 'EqLs',
            ...
            BT_COND_LOGIC_CONT => array(
                ...
                'OP' => array(
                    ...
                    'Y' => 'CAcritGlobalCondCtrl::LogicContain(#FIELD#, #VALUE#)'
                ),
                'PARENT' => ' || ',
                'MULTI_SEP' => ' || ',
                'VALUE' => 'Contain',
            ...
            BT_COND_LOGIC_NOT_CONT => array(
                ...
                'OP' => array(
                    'N' => 'false === strpos(#FIELD#, #VALUE#)',
                    'Y' => 'CAcritGlobalCondCtrl::LogicNotContain(#FIELD#, #VALUE#)'
                ),
                'PARENT' => ' && ',
                'MULTI_SEP' => ' && ',
                'VALUE' => 'NotCont',
...
class CAcritGlobalCondCtrlComplex extends CAcritGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $strClassName = get_called_class();
...
class CAcritGlobalCondCtrlAtoms extends CAcritGlobalCondCtrl
{
    /**
     * @return array|bool
     */
...
class CAcritGlobalCondCtrlGroup extends CAcritGlobalCondCtrl
{
    public static function GetControlDescr()
    {
        $className = get_called_class();
...
class CAcritCatalogCondCtrl extends CAcritGlobalCondCtrl
{
}

class CAcritCatalogCondCtrlComplex extends CAcritGlobalCondCtrlComplex
{
}

class CAcritCatalogCondCtrlGroup extends CAcritGlobalCondCtrlGroup
{
    public static function GetControlDescr()
    {
...
class CAcritCatalogCondCtrlIBlockFields extends CAcritCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
...
class CAcritCatalogCondCtrlIBlockProps extends CAcritCatalogCondCtrlComplex
{
    public static function GetControlDescr()
    {
        $description = parent::GetControlDescr();
                        ...
                        if (isset($arProp['USER_TYPE']) && !empty($arProp['USER_TYPE']))
                        {
                            switch ($arProp['USER_TYPE'])
                            {
                                ...
                                case 'directory':
                                    ...
                                    $arValue = array(
                                        'type' => 'lazySelect',
                                        'load_url' => '/local/tools/catalog/get_property_values.php',
                                        'load_params' => array(
                                            'lang' => LANGUAGE_ID,
...
class CAcritCatalogCondTree extends CAcritGlobalCondTree
{
    public function __construct()
    {
        parent::__construct();
