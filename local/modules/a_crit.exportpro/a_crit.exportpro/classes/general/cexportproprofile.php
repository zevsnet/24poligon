...
class CExportproProfile{
    ...
    function createFieldset2( $IBLOCK, $SKU = false, $PRICE = false ){
        ...
        $Properties = array(
            ...
            "SECTION.DESCRIPTION" => GetMessage( "ACRIT_EXPORTPRO_FIELD_SECTION.DESCRIPTION" ),
            "SECTION.PICTURE" => GetMessage( "ACRIT_EXPORTPRO_FIELD_SECTION.PICTURE" ),
            "SECTION.DETAIL_PICTURE" => GetMessage( "ACRIT_EXPORTPRO_FIELD_SECTION.DETAIL_PICTURE" ),
        ...
        if( @CModule::IncludeModule( "catalog" ) ){
            ...
            foreach( $arCatalogProductFields as $catalogProductField ){
                $arIBlock["CATALOG"][$catalogProductField] = GetMessage( "ACRIT_EXPORTPRO_".$catalogProductField."_FIELD" );
            }
            ...
            $arIBlock["CATALOG"]["HEIGHT"] = GetMessage( "ACRIT_EXPORTPRO_HEIGHT" );
						*/
            $arIBlock["CATALOG"]["BARCODE"] = GetMessage( "ACRIT_EXPORTPRO_FIELD_BARCODE" );
						/*
    ...
    public function createBlockFieldset( $arIBlock ){
        ...
        if( is_array( $arIBlock ) ){
            foreach( $arIBlock as $IB_ID => $arFields ){
                if( is_array( $arFields["FIELDS"] ) && ( sizeof( $arFields["FIELDS"] ) > 0 ) && !$fieldsSetup ){
                    $options["FIELDS"] = array( GetMessage( "ACRIT_EXPORTPRO_POLA" ) );
                    $optionsFields = array();
                    foreach( $arFields["FIELDS"] as $idf => $fields ){
                ...
                if( is_array( $arFields["PROPERTY"] ) && sizeof( $arFields["PROPERTY"] ) > 0 ){
                    $options["PROPERTY"][$IB_ID] = array( GetMessage( "ACRIT_EXPORTPRO_SVOYSTVA" ).$arFields["NAME"] );
                ...
                if( is_array( $arFields["OFFERS_PROPERTY"] ) && sizeof( $arFields["OFFERS_PROPERTY"] ) > 0 ){
                    $options["OFFERS_PROPERTY"] = array( GetMessage( "ACRIT_EXPORTPRO_SVOYSTVA1" ).$arFields["NAME"] );
            ...
            if( is_array( $arIBlock["CATALOG"] ) && sizeof( $arIBlock["CATALOG"] ) > 0 ){
                $options["CATALOG"] = array( GetMessage( "ACRIT_EXPORTPRO_SVOYSTVA_TORGOVOGO_K" ).$arFields["NAME"] );
    ...
    public function GetSchemePreviewPicture(){
        $schemes = array(
            "PREVIEW_PICTURE_SKU"                => GetMessage( "ACRIT_EXPORTPRO_SCHEME_DETAIL_OFFER_PREVIEW_PICTURE" ),
            "PREVIEW_PICTURE_OFFER"              => GetMessage( "ACRIT_EXPORTPRO_SCHEME_DETAIL_PRODUCT_PREVIEW_PICTURE" ),
            "PREVIEW_PICTURE_OFFER_IF_SKU_EMPTY" => GetMessage( "ACRIT_EXPORTPRO_SCHEME_OFFER_IF_SKU_EMPTY" ),
        );
    ...
    public function GetSchemeCatalogPrice(){
        $schemes = array(
            "CATALOG_PRICE_SKU"                => GetMessage( "ACRIT_EXPORTPRO_SCHEME_DETAIL_OFFER_CATALOG_PRICE" ),
            "CATALOG_PRICE_OFFER"              => GetMessage( "ACRIT_EXPORTPRO_SCHEME_DETAIL_PRODUCT_CATALOG_PRICE" ),
            "CATALOG_PRICE_OFFER_IF_SKU_EMPTY" => GetMessage( "ACRIT_EXPORTPRO_SCHEME_OFFER_IF_SKU_EMPTY" ),
        );
