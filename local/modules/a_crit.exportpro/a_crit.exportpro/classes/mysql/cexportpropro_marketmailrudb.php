...
class CExportproMarketMailruDB
{
    private $tableName = "acrit_exportpro_market_mailru";
    ...
    public function Add( array $arFields )
    {
        ...
        foreach ($arFields as $fieldsItemIndex => $arFieldsItem) {
            if (in_array($fieldsItemIndex, $arDataFields)) {
	            $arResultFields[$fieldsItemIndex] = $arFieldsItem;
            }
        }
