CREATE TABLE IF NOT EXISTS `acrit_exportpro_profile`(
    ...
    `USE_AUTOFILL_PROPS` CHAR(1) DEFAULT 'N' NOT NULL,
    `USE_EMPTY_TAG_CUT` CHAR(1) DEFAULT 'Y' NOT NULL,
    `USE_AUTOPRICE` CHAR(1) DEFAULT 'N' NOT NULL,
    `CHANGE_MARKET_CATEGORY` CHAR(1) DEFAULT 'N' NOT NULL,
    ...
    `SETUP` LONGTEXT NULL,
    `USE_IBLOCK_CATEGORY` CHAR(1) DEFAULT 'N' NOT NULL,
    `USE_IBLOCK_PRODUCT_CATEGORY` CHAR(1) DEFAULT 'N' NOT NULL,
    `EXPORT_DATA_OFFER` CHAR(1) DEFAULT 'Y' NOT NULL,
    `SKIP_WITH_SKU` CHAR(1) DEFAULT 'N' NOT NULL,
    `EXPORT_DATA_OFFER_WITH_SKU_DATA` CHAR(1) DEFAULT 'Y' NOT NULL,
    `EXPORT_DATA_SKU` CHAR(1) DEFAULT 'Y' NOT NULL,
    `EXPORT_DATA_SKU_BY_OFFER` CHAR(1) DEFAULT 'N' NOT NULL,
    PRIMARY KEY (ID)
);
...
CREATE TABLE IF NOT EXISTS `acrit_exportpro_profile_data`(
    ...
    `IBLOCK_AUTOFILL_PROPS` LONGTEXT NULL,
