...
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_EXPORT_TITLE"] = "Экспорт выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_IMPORT_TITLE"] = "Импорт выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_PROCESS"] = "  Продолжить  ";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_BACK"] = "  Назад  ";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_EXPORT_FILE_TITLE"] = "Выберите файл для экспорта выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_IMPORT_FILE_TITLE"] = "Выберите файл для импорта выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_EXPORTED1"] = "Выгрузки успешно выгружены: <br/>";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_EXPORTED2"] = "<a href='#FILE#' target='_blank'>#FILE#</a><br/>";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST_EXPORTED3"] = "Выгрузки успешно добавлены: <br/>";
$MESS["ACRIT_EXPORTPRO_PROFILE_LIST"] = "  К списку выгрузок   ";
$MESS["ACRIT_EXPORTPRO_PROFILE_TABLE_EXPORT_IMPORT_TITLE"] = "Экспорт/импорт выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_TABLE_EXPORT_TITLE"] = "Экспорт выгрузок";
$MESS["ACRIT_EXPORTPRO_PROFILE_TABLE_IMPORT_TITLE"] = "Импорт выгрузок";
$MESS["ACRIT_EXPORTPRO_RUN_TYPE_COMPONENT"] = "Ручной";
$MESS["ACRIT_EXPORTPRO_RUN_TYPE_CRON"] = "Автоматический";
