...
$MESS["ACRIT_EXPORTPRO_SCHEME_NAMESCHEMA_PREVIEWPICTURE"] = "Выводить картинку анонса торговых предложений:";
...
$MESS["ACRIT_EXPORTPRO_SCHEME_NAMESCHEMA_CATALOG_PRICE"] = "Выводить цены торговых предложений:";
$MESS["ACRIT_EXPORTPRO_SCHEME_OFFER_IF_SKU_EMPTY"] = "Брать из товарного предложения, а в случае отсутствия значения - из товара";

$MESS["ACRIT_EXPORTPRO_SCHEME_NAMESCHEMA_DATA_SELECT"] = "Товар/Торговое предложение - сущности выгрузки";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_OFFER"] = "Товары";
$MESS["ACRIT_EXPORTPRO_SCHEME_SKIP_WITH_SKU"] = "НЕ выгружать товары, имеющие торговые предложения";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_OFFER_WITH_SKU_DATA"] = "Товары с элементами торговых предложений";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_SKU"] = "Торговые предложения";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_SKU_BY_OFFER"] = "Торговые предложения товаров по условиям";
$MESS["ACRIT_EXPORTPRO_SCHEME_USE_EMPTY_TAG_CUT"] = "Вырезать пустые теги";
$MESS["ACRIT_EXPORTPRO_SCHEME_USE_AUTOPRICE"] = "Авторасчет цены";

$MESS["ACRIT_EXPORTPRO_SCHEME_NAMESCHEMA_SELECT"] = "Торговое предложение - выбор данных";
...
контейнера торговых предложений и других необходимых тегов.<br/>
...
Если необходимо удалить или добавить какой-либо тег из шапки файла, то он добавляется или удаляется из данной области вручную.
";
...
$MESS["ACRIT_EXPORTPRO_SCHEME_TAGS_DESCRIPTION"] = "
    ...
    Содержимое тегов может быть прописано непосредственно внутри тега или в <b>#ПОЛЕ-ЭКСПОРТА#</b>.<br/>
    Название <b>#ПОЛЕЙ-ЭКСПОРТА#</b> может быть различным и не совпадать с названием тега,<br/>
    но обязательно совпадать с названием переменной на вкладке \"Теги выгрузки\" без решеток (#) вначале и в конце.<br/>
    Например для тега <b>price</b> (&lt;price&gt;#Main_Price#&lt;price&gt;) мы задали шаблон переменную <b>#Main_Price#</b>,<br/>
    а в тегах выгрузки она должна называться <b>Main_Price</b> и ей будет соответствовать какой-нибудь тип цены.<br/>
    Теги для который соответствие <b>#ПОЛЕЙ-ЭКСПОРТА#</b> в тегах выгрузки не заданы или значение их не определено<br/>
    будут удалены из товарного предложения. Так же можно комбинировать статические данные и #ТЕГИ ВЫГРУЗКИ#.<br/>
    Например, у вас есть тег &lt;url&gt;#URL#&lt;/url&gt;, в инфоблоке у вас прописан шаблон для детального отображения относительный<br/>
    /catalog/auto/audi-a6/, вы можете добавить доменное имя в тег &lt;url&gt;http://mysite.ru#URL#&lt;/url&gt;.<br/>
    Название #ПОЛЕЙ-ЭКСПОРТА# может быть любым, за исключением названий служебных шаблонов.<br/>
    <b>#MARKET_CATEGORY#</b> - Категория соответствующая спецификации торгового портала на вкладке \"Категории выгрузки\", служебный шаблон<br/>
";
...
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_OFFER_HELP"] = "Выгрузить товары, т.е. <b>элементы инфоблока, которые имеют цену, кроме их торговых предложений</b>. В данном случае понятие «товар» никак не связано с понятием «Торговое предложение», т.е. неверно полагать, что товар это элемент инфоблока, у которого нет торговых предложений - т.к. цена может быть задана и у товара, имеющего торговые предложения.";
$MESS["ACRIT_EXPORTPRO_SCHEME_SKIP_WITH_SKU_HELP"] = "Отметьте данную опцию, если необходимо отменить выгрузку товаров, имеющих торговые предложения.<br/><br/>Это актуально в случае, если цена задана как у торговых предложений, так и у самого товара, к которым они относятся - в таком случае будет выгружаться и то и другое. Данная опция позволяет отменить выгрузку товаров в подобных случаях.";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_OFFER_WITH_SKU_DATA_HELP"] = "Выгрузить товары с элементами торговых предложений";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_SKU_HELP"] = "Выгрузить торговые предложения";
$MESS["ACRIT_EXPORTPRO_SCHEME_EXPORT_DATA_SKU_BY_OFFER_HELP"] = "Выгрузить торговые предложения отобранных по условиям в \"Опциях выгрузки\" товаров";
$MESS["ACRIT_EXPORTPRO_SCHEME_USE_EMPTY_TAG_CUT_HELP"] = "Вырезать пустые теги";
$MESS["ACRIT_EXPORTPRO_SCHEME_USE_AUTOPRICE_HELP"] = "Использовать авторасчет цены в случае отсутствия у товара выбранной в Тегах выгрузки";
?>