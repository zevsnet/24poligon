...
$MESS["ACRIT_EXPORTPRO_FIELDSET_DESCRIPTION"] = "
    <b>\"ТЕГИ ВЫГРУЗКИ\"</b> заменяются значениями. Если значение не задано или неопределено,<br/>
    то тег в выгрузке предложения будет пропущен. Если установлена галочка <b>\"обязательное\"</b> поле и тег<br/>
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_PROCESS_LOGIC"] = "Обрабатывать полученное значение";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY"] = "Удалять тег, если значение не установлено";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_FORCE"] = "Удалять тег целиком (вне зависимости от атрибутов), если значение не установлено";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_ROWFORCE"] = "Удалять тег целиком на уровне структуры выгрузки (FORCE), если значение не установлено";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_EXPORT_ROWCATEGORY_PARENT_LIST"] = "Выгружать цепочку категорий";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_TO_STRING"] = "Преобразовать значения множественного тега в строку";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_DIVIDER"] = "Разделитель преобразования множественного тега в строку";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_LIMIT"] = "Количество выбираемых значений из множественного тега";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_FORMAT"] = "Схема обработки множественного тега";
$MESS["ACRIT_EXPORTPRO_FIELDSET_TEXT_LIMIT"] = "Количество символов в обрезанной строке";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_ROUND_PRECISION"] = "Количество десятичных знаков (округление)";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_BITRIX_ROUND_MODE"] = "Использовать округлений цен из настроек Интернет-магазина";
$MESS["ACRIT_EXPORTPRO_FIELDSET_BITRIX_ROUND_MODE_CODE"] = "";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE"] = "Получить минимальную цену торговых предложений";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE"] = "Название тега выгрузки минимальной цены";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_PROCESS_LOGIC_HELP"] = "Установка этой опции позволяет получить конечные значения выбранного набора данных. Например, в случае необходимости выбора из свойства инфоблока типа \"Привязка к элементам\" значений привязанных элементов опцию необходимо установить. В случае же необходимости получения только ID самих привязанных элементов - снять";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_HELP"] = "Установка этой опции позволит полностью удалить даже сам тег из файла в случае, если ему устанавливается пустое значение";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_FORCE_HELP"] = "Установка этой опции позволит полноcтью удалить тег ВМЕСТЕ СО ВСЕМИ АТРИБУТАМИ из файла в случае, если ему устанавливается пустое значение";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_ROWFORCE_HELP"] = "Установка этой опции позволит полноcтью удалить физический тег (FORCE) на уровне структуры выгрузки из файла в случае, если данному тегу выгрузки устанавливается пустое значение";
$MESS["ACRIT_EXPORTPRO_FIELDSET_DELETE_ONEMPTY_ATTRIBUTES_HELP"] = "Установка этой опции позволит полностью удалить атрибуты тега из файла в случае, если им устанавливается пустое значение";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_EXPORT_ROWCATEGORY_PARENT_LIST_HELP"] = "Выгружать в цепочку полное дерево (вверх от выбранной в теге категории) категорий";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_TO_STRING_HELP"] = "Установка данного флага позволяет трасформировать значения множественного тега в строку через разделитель. По умолчанию: пробел";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_DIVIDER_HELP"] = "Разделитель, размещаемый между значениями множественного тега, при преобразовании в строку";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_LIMIT_HELP"] = "Количество выбираемых значений из множественного тега";
$MESS["ACRIT_EXPORTPRO_FIELDSET_MULTIPROP_FORMAT_HELP"] = "Указывается схема обработки множественного тега. Например, следующая запись: 1, 3-5, 12 - выберет 1, 3, 4, 5 и 12 значение из множественного тега.";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_BITRIX_ROUND_MODE_HELP"] = "Функция получения настроек округления из настроек Интернет-магазина";
$MESS["ACRIT_EXPORTPRO_FIELDSET_BITRIX_ROUND_MODE_CODE_HELP"] ="";
...
$MESS["ACRIT_EXPORTPRO_FIELDSET_MINIMUM_OFFER_PRICE_CODE_HELP"] ="Название <b>#ТЕГИ ВЫГРУЗКИ#</b><br/>которому будет присвоена<br/>минимальная цена торговых предложений";
$MESS["ACRIT_EXPORTPRO_FIELDSET_ROUND_PRECISION_HELP"] = "Количество десятичных знаков дробной части";
