...
$MESS["ACRIT_EXPORTPRO_UA_PRICE_UA_FIELD_NAME"] = "Наименование торгового предложения.<br/><b>Обязательный элемент</b>";
...
$MESS["ACRIT_EXPORTPRO_UA_PRICE_UA_FIELD_DESCRIPTION"] = "Описание товара.<br/>Длина текста не более 175 символов (не включая знаки препинания),<br/> запрещено использовать HTML-теги <br/>(информация внутри тегов публиковаться не будет)";
...
$MESS["ACRIT_EXPORTPRO_UA_PRICE_UA_FIELD_AVAILABLE_AREA_DEFAULT_VALUE"] = "Склад";
...
<item id=\"330\">
    ...
    <description>GSM 900/1800/1900. Тип корпуса: раскладушка.</description>
