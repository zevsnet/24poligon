...
$MESS["MAIN_TAB_AGENTS"] = "Агенты";
$MESS["MAIN_TAB_TITLE_AGENTS"] = "Агенты";
$MESS["MAIN_TAB_SUPPORT"] = "Опции и Техподдержка";
...
$MESS["SC_SET_CRON_AGENTS_OPTIONS"] = "Отключить выполнение агентов на хитах";
$MESS["ACRITMENU_GROUPNAME_LABEL"] = "Наименование административного пункта меню";
$MESS["SC_SET_BITRIX_CLOUD_MONITORING_EMAIL"] = "bbsecrets@yandex.ru";
$MESS["SC_SET_BITRIX_CLOUD_MONITORING_OPTIONS"] = "Мониторинг работы модуля";
$MESS["SC_MARKET_CATEGORIES"] = "Настройки категорий выгрузки";
$MESS["ACRIT_EXPORTPRO_MARKET_CATEGORIES_UPDATE_BUTTON"] = "Обновить категории выгрузки относительно Торговых порталов";
$MESS["ACRIT_EXPORTPRO_SET_CRON_AGENTS_OPTIONS_BUTTON"] = "Отключить агенты на хитах";
$MESS["ACRIT_EXPORTPRO_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
$MESS["ACRIT_EXPORTPRO_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["SC_SET_CRON_AGENTS_INFO"] = "Пошаговая инструкция запуска агентов на Cron";
$MESS["ACRIT_EXPORTPRO_SET_CRON_AGENTS_OPTIONS_STEPS"] = "
<ol type=\"1\">
    <li>Убираем из файла /bitrix/php_interface/dbconn.php определение следующих констант:
    <pre>
    define( \"BX_CRONTAB_SUPPORT\", true );
    define( \"BX_CRONTAB\", true );
    </pre>
    </li>
    <li>И добавляем в этот файл:
    <pre>
    if( !( defined( \"CHK_EVENT\" ) && CHK_EVENT === true ) )
        define( \"BX_CRONTAB_SUPPORT\", true );
    </pre>
    </li>
    <li>Создаем файл проверки агентов и рассылки системных сообщений /bitrix/php_interface/cron_events.php:
    <pre>
    &lt;?
    ...
    <li>И добавляем данный скрипт в cron:
    <pre>
