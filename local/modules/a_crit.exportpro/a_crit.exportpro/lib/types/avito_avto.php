...
$profileTypes["avito_avto"] = array(
	...
	"FIELDS" => array(
        ...
        array(
            "CODE" => "ListingFee",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_LISTINGFEE" ),
        ),
        array(
            "CODE" => "AdStatus",
        ...
        array(
            "CODE" => "AvitoId",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_AVITOID" ),
        ),
        array(
            "CODE" => "AllowEmail",
        ...
        array(
            "CODE" => "Street",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_STREET" ),
        ),
        array(
            "CODE" => "Latitude",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_LATITUDE" ),
        ),
        array(
            "CODE" => "Longitude",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_LONGTITUDE" ),
        ),
        array(
            "CODE" => "Description",
...
if( CModule::IncludeModule( "catalog" ) ){
    ...
    $profileTypes["avito_avto"]["FIELDS"][19] = array(
        "CODE" => "Price",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_AVITO_AVTO_FIELD_PRICE" ),
        "TYPE" => "field",
        "VALUE" => $basePriceCode,
