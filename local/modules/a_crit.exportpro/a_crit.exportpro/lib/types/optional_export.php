...
$profileTypes["optional"] = array(
	...
	"FIELDS" => array(
        ...
        array(
            ...
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_OPTIONAL_FIELD_BASEORDERBEFORE" ),
        ),
		array(
			"CODE" => "URL",
        ...
        array(
            ...
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_OPTIONAL_FIELD_LOCALORDERBEFORE" ),
        ),
        array(
            "CODE" => "NAME",
        ...
        array(
            "CODE" => "PARAM3",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_OPTIONAL_FIELD_PARAM_WIDTH" ),
            "TYPE" => "const",
            "CONTVALUE_TRUE" => GetMessage( "ACRIT_EXPORTPRO_OPTIONAL_FIELD_PARAM_WIDTH_VALUE" )
        ),
        array(
            "CODE" => "PARAM4",
...
if( CModule::IncludeModule( "catalog" ) ){
    ...
    $profileTypes["optional"]["FIELDS"][7] = array(
        "CODE" => "OLDPRICE",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_OPTIONAL_FIELD_OLDPRICE" ),
        "TYPE" => "field",
        "VALUE" => $basePriceCode,
