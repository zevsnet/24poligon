...
$profileTypes["ua_hotline_ua"] = array(
    ...
    "FIELDS" => array(
        ...
        array(
            ...
            "TYPE" => "const",
            "CONTVALUE_TRUE" => GetMessage( "ACRIT_EXPORTPRO_UA_HOTLINE_UA_FIELD_STOCK_STOCK_STATUS_DEFAULT_VALUE" ),
        ),
        array(
            "CODE" => "GUATANTEE_TYPE",
        ...
        array(
            ...
            "TYPE" => "const",
            "CONTVALUE_TRUE" => GetMessage( "ACRIT_EXPORTPRO_UA_HOTLINE_UA_FIELD_STOCK_STOCK_ORIGINAL_DEFAULT_VALUE" ),
        ),
        array(
...
<item>
    ...
    <param name='".GetMessage( "ACRIT_EXPORTPRO_UA_HOTLINE_UA_FIELD_STOCK_STOCK_ORIGINAL_CONST" )."'>#ORIGINAL#</param>
    <param name='".GetMessage( "ACRIT_EXPORTPRO_UA_HOTLINE_UA_FIELD_COUNTRYOFORIGIN_CONST" )."'>#COUNTRY_OF_ORIGIN#</param>
