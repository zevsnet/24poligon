...
$profileTypes["wikimart_clothes"] = array(
    ...
    "FIELDS" => array(
        ...
        array(
            "CODE" => "UNIT",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_WIKIMART_CLOTHES_FIELD_PARAM_UNIT" ),
            "TYPE" => "const",
            "CONTVALUE_TRUE" => "RU",
        ),
        array(
...
<offer id=\"#ID#\" type=\"vendor.model\" available=\"#AVAILABLE#\">
    ...
    <param name=\"".GetMessage( "ACRIT_EXPORTPRO_WIKIMART_CLOTHES_FIELD_PARAM_COLOR" )."\">#PARAM1#</param>
    <param name=\"".GetMessage( "ACRIT_EXPORTPRO_WIKIMART_CLOTHES_FIELD_PARAM_SIZE" )."\" unit=\"#UNIT#\">#PARAM2#</param>
    <param name=\"".GetMessage( "ACRIT_EXPORTPRO_WIKIMART_CLOTHES_FIELD_PARAM_GENDER" )."\">#PARAM3#</param>
    <param name=\"".GetMessage( "ACRIT_EXPORTPRO_WIKIMART_CLOTHES_FIELD_PARAM_OLD" )."\">#PARAM4#</param>
</offer>
";
