...
$profileTypes["ym_book"] = array(
	...
	"FIELDS" => array(
        ...
        array(
            "CODE" => "CBID",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_BOOK_FIELD_CBID" ),
            "VALUE" => "",
        ),
        array(
            "CODE" => "FEE",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_BOOK_FIELD_FEE" ),
            "VALUE" => "",
        ),
        array(
        ...
        array(
            ...
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_BOOK_FIELD_BASEORDERBEFORE" ),
        ),
        array(
			"CODE" => "URL",
        ...
        array(
            "CODE" => "VAT",
            "NAME" => GetMessage( "ACRIT_EXPORTPROPLUS_MARKET_BOOK_FIELD_VAT" ),
        ),
		array(
			"CODE" => "CATEGORYID",
        ...
        array(
			...
			"NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_BOOK_FIELD_LOCALORDERBEFORE" ),
		),
        array(
			"CODE" => "AUTHOR",
...
if( CModule::IncludeModule( "catalog" ) ){
    ...
    $profileTypes["ym_book"]["FIELDS"][9] = array(
        "CODE" => "PRICE",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_BOOK_FIELD_PRICE" ),
        "REQUIRED" => "Y",
        "TYPE" => "field",
...
<offer id=\"#ID#\" type=\"book\" available=\"#AVAILABLE#\" bid=\"#BID#\" cbid=\"#CBID#\" fee=\"#FEE#\">
