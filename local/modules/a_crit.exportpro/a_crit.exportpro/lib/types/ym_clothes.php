...
$profileTypes["ym_clothes"] = array(
    ...
    "FIELDS" => array(
        ...
        array(
            "CODE" => "CBID",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_CBID" ),
            "VALUE" => "",
        ),
        array(
            "CODE" => "FEE",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_FEE" ),
            "VALUE" => "",
        ),
        array(
        ...
        array(
            ...
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_BASEORDERBEFORE" ),
        ),
        array(
            "CODE" => "URL",
        ...
        array(
            "CODE" => "VAT",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_VAT" ),
        ),
        array(
            "CODE" => "CATEGORYID",
        ...
        array(
            "CODE" => "GROUPID",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_GROUPID" ),
            "TYPE" => "field",
        ),
        array(
            "CODE" => "PICTURE",
        ...
        array(
            ...
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_LOCALORDERBEFORE" ),
        ),
        array(
            "CODE" => "TYPEPREFIX",
...
if( CModule::IncludeModule( "catalog" ) ){
    ...
    $profileTypes["ym_clothes"]["FIELDS"][9] = array(
        "CODE" => "PRICE",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_PRICE" ),
        "REQUIRED" => "Y",
        "TYPE" => "field",
    ...
    $profileTypes["ym_clothes"]["FIELDS"][10] = array(
        "CODE" => "OLDPRICE",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_CLOTHES_FIELD_OLDPRICE" ),
        "TYPE" => "field",
        "VALUE" => $basePriceCode,
