...
if( CModule::IncludeModule( "catalog" ) ){
    ...
    $profileTypes["ym_realty"]["FIELDS"][38] = array(
        "CODE" => "PRICE_VALUE",
        "NAME" => GetMessage( "ACRIT_EXPORTPRO_REALTY_FIELD_PRICE_VALUE" ),
        "REQUIRED" => "Y",
        "TYPE" => "field",
...
$profileTypes["ym_realty"]["PORTAL_REQUIREMENTS"] = GetMessage( "ACRIT_EXPORTPRO_TYPE_REALTY_PORTAL_REQUIREMENTS" );
$profileTypes["ym_realty"]["PORTAL_VALIDATOR"] = GetMessage( "ACRIT_EXPORTPRO_TYPE_REALTY_PORTAL_VALIDATOR" );
$profileTypes["ym_realty"]["EXAMPLE"] = GetMessage( "ACRIT_EXPORTPRO_TYPE_REALTY_EXAMPLE" );

$profileTypes["ym_realty"]["ITEMS_FORMAT"] = "
