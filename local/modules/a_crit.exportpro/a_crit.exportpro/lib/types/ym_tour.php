...
$profileTypes["ym_tour"] = array(
	...
	"FIELDS" => array(
        ...
        array(
            "CODE" => "CBID",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_TOUR_FIELD_CBID" ),
            "VALUE" => "",
        ),
        array(
            "CODE" => "FEE",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_TOUR_FIELD_FEE" ),
            "VALUE" => "",
        ),
		array(
			"CODE" => "URL",
        ...
        array(
            "CODE" => "VAT",
            "NAME" => GetMessage( "ACRIT_EXPORTPRO_MARKET_TOUR_FIELD_VAT" ),
        ),
		array(
			"CODE" => "CATEGORYID",
