...
// Askaron++
if (!\Bitrix\Main\Loader::includeModule("askaron.parallel1c") )
{
	$APPLICATION->RestartBuffer();
	echo "Module askaron.parallel1c not installed";
	die();
};

$arAskaronParallelsSettings = \Askaron\Parallel1c\Tools::getSettingsByPath();
if (!$arAskaronParallelsSettings)
{
	$APPLICATION->RestartBuffer();
	echo "askaron.parallel1c path not found!";
	die();
};
// Askaron--
...
elseif($type=="catalog")
{
		$APPLICATION->IncludeComponent("nf:catalog.import.1c", "", Array(
