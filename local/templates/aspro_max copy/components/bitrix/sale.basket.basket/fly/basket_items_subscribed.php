										...
										<div class="props">
											<?foreach ($arItem["PROPS"] as $val) {
													if (is_array($arItem["SKU_DATA"])) {
														...
														if ($bSkip) continue;
													} echo '<div class="item_prop"><span class="name">'.$val["NAME"].':&nbsp;</span><span class="property_value">'.$val["VALUE"].'</span></div>';
											}?>
										</div>
									<?endif;?>
	...
	<div class="foot clearfix">
		<div class="pull-left">
			<span class="wrap_remove_button basket_action">
				<?if($delayCount){?>
					<span class="colored_theme_hover_text remove_all_basket SubDelCanBuy cur" data-type="subscribe">
		...
		<?if($arResult["SUBSCRIBE_PRICE"]["SUMM_FORMATED"]):?>
			<div class="total pull-right">
				<div class="item_title"><?=GetMessage("SALE_TOTAL");?></div>
				<div class="wrap_prices">
					<div class="price"><?=$arResult["SUBSCRIBE_PRICE"]["SUMM_FORMATED"]?></div>
				</div>
			</div>
		<?endif;?>
	</div>
