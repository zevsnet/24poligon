...
else
{
    ...
    <form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
        ...
        <div id="bx-soa-order" class="row orderform--v1 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
            ...
            <div class="col-sm-9 bx-soa">
                ...
                <div id="bx-soa-type" data-visited="false" class="bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container">
                        <h2 class="bx-soa-section-title col-sm-9">
                            <span class="bx-soa-section-title-count"></span><?=$arParams['MESS_TYPE_BLOCK_NAME']?>
                        </h2>
                    </div>
                    <div class="bx-soa-section-content container-fluid"></div>
                </div>
    ...
    <script>
        ...
        BX.Sale.OrderAjaxComponent.init({
            ...
            showWarnings: true,
            deliveryPickupId:[40,73,80,81,77,79],
            deliveryPickupDefaultType:'delivery',
            pickUpMap: {
                defaultMapPosition: {
                    lat: 55.76,
                    lon: 37.64,
