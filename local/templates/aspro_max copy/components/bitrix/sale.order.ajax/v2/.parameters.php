...
if ($arCurrentValues['USE_YM_GOALS'] == 'Y')
{
	...
	$arTemplateParameters["YM_GOALS_MAX_REGION"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_REGION"),
		"TYPE" => "STRING",
		"DEFAULT" => "BX-region-next",
		"PARENT" => "ANALYTICS_SETTINGS"
	);
	$arTemplateParameters["YM_GOALS_MAX_DELIVERY"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_DELIVERY"),
		"TYPE" => "STRING",
		"DEFAULT" => "BX-delivery-next",
		"PARENT" => "ANALYTICS_SETTINGS"
	);
	$arTemplateParameters["YM_GOALS_MAX_PICKUP"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_PICKUP"),
		"TYPE" => "STRING",
		"DEFAULT" => "BX-pickUp-next",
		"PARENT" => "ANALYTICS_SETTINGS"
	);
	$arTemplateParameters["YM_GOALS_MAX_PAY_SYSTEM"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_PAY_SYSTEM"),
		"TYPE" => "STRING",
		"DEFAULT" => "BX-paySystem-next",
		"PARENT" => "ANALYTICS_SETTINGS"
	);
	$arTemplateParameters["YM_GOALS_MAX_PROPERTIES"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_PROPERTIES"),
		"TYPE" => "STRING",
		"DEFAULT" => "BX-properties-next",
		"PARENT" => "ANALYTICS_SETTINGS"
	);
	$arTemplateParameters["YM_GOALS_MAX_BASKET"] = array(
		"NAME" => GetMessage("YM_GOALS_MAX_BASKET"),
		"TYPE" => "STRING",
...
if ($arCurrentValues['USE_CUSTOM_MAIN_MESSAGES'] == 'Y')
{
	...
	$arTemplateParameters["MESS_MORE_DETAILS"] =  array(
		"NAME" => GetMessage("MORE_DETAILS"),
		"TYPE" => "STRING",
		"DEFAULT" => GetMessage("MORE_DETAILS_DEFAULT"),
		"PARENT" => "MAIN_MESSAGE_SETTINGS"
	);
