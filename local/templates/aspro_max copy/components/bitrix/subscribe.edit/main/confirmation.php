...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table confirm">
...
<tfoot><tr><td colspan="2"><br/><input type="submit" class="btn btn-default" name="confirm" value="<?echo GetMessage("subscr_conf_button")?>" /></td></tr></tfoot>
</table>
