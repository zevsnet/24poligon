...
<?else:?>
	<div class="module-enter have-user">
		...
		global $USER;
		$arPhoto=array();
		$arUser=CMaxCache::CUser_GetList(array("SORT"=>"ASC", "CACHE" => array("MULTI" => "N", "TAG"=>CMaxCache::GetUserCacheTag($USER->GetID()))), array("ID"=>$USER->GetID()), array("FIELDS"=>array("ID", "PERSONAL_PHOTO")));
