!function (e, t) {
    ...
    var y = {
            ...
            areSame: function e(t, n) {
                var i = !0;
                return typeof t == typeof n && ("object" == typeof t && null != t && null != n ? (m.each(t, function (t, s) {
                    return i = e(t, n[s])
                }), i) : t === n)
            }, assign: function (e, t) {
        ...
        E = new RegExp("[\\-\\+\\\\\\?!@#$%^&]+", "g"), k = {
            escapeHtml: function (e) {
                ...
                var n = m.compact(k.formatToken(e).split(C)), i = m.minus(n, t), s = m.minus(n, i);
        ...
        D = [{id: "kladr_id", fields: ["kladr_id"], forBounds: !1, forLocations: !0}, {
            ...
            composeValue: function (e, t) {
                var n = e.country,
                    ...
                    c = m.compact([e.flat_type, e.flat]).join(" "), d = e.postal_box && "а/я " + e.postal_box;
            ...
            composeValue: function (e, t) {
                var n = e.country,
                    ...
                    d = m.compact([e.flat_type, e.flat]).join(" "), f = e.postal_box && "а/я " + e.postal_box;
    ...
    var te = {width: "auto", floating: !1}, ne = {
        createContainer: function () {
            ...
            var o, r, a, u, d, f, p, g = this, h = [], y = s && s.unformattableTokens, m = s && s.maxLength,
                _ = V.reWordExtractor();
            if (!t) return "";
    ...
    var ae = {
        createConstraints: function () {
            ...
            }), !y.isEmptyObject(n)) return n.kladr_id ? {kladr_id: n.kladr_id} : n
            ...
            var e = this, t = y.isPlainObject(e.constraints) && Object.keys(e.constraints)[0];
