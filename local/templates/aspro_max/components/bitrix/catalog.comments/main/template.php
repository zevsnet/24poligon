		...
		<ul class="bx-catalog-tab-list1 nav nav-tabs" style="left: 0;"><?
			foreach ($arData as $tabId => $arTab)
			{
				if (isset($arTab["NAME"]) && isset($arTab["CONTENT"]))
				{
					...
					switch ($tabId) {
						case "BLOG":
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/comments.svg';
							break;
						case "VK":
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/social_vk.svg';
							break;
						case "FB":
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/social_facebook.svg';
							break;
						/*default:
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/social_vk.svg';*/
					}
					...
					?><li id="<?=$id?>" class="muted bordered font_upper_md <?=$tabId;?>"><a href="#<?=$id;?>_cont" data-toggle="tab"><?=($iconSVG ? CMax::showIconSvg(strtolower($tabId), $iconSVG) : '');?><?=$arTab["NAME"]?></a></li><?
