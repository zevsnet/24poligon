										...
										<?if($bImage || $onlyImgPart):?>
											<div class="image <?=($bImage ? ' w-picture' : ' wo-picture wpi')?>">
												...
												<?elseif(isset($arItem['FIELDS']['DETAIL_PICTURE'])):?>
													<a href="<?=$imageDetailSrc?>" alt="<?=($bImage ? $arItem['PREVIEW_PICTURE']['ALT'] : $arItem['NAME'])?>" title="<?=($bImage ? $arItem['PREVIEW_PICTURE']['TITLE'] : $arItem['NAME'])?>" data-caption="<?=$arItem['NAME'];?>" class="img-inside fancy">
												<?endif;?>
