...
<? if ($arParams['SHOW_TOP_MAP'] != 'Y'): ?>
    <div class="contacts-page-top" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-4 col-sm-6">
                                <select class="<?= ($bHasChildSections ? 'region' : 'city'); ?>">
                                    <option value="0"
                                            selected><?= Loc::getMessage('CHOISE_ITEM', array('#ITEM#' => ($bHasChildSections ? Loc::getMessage('REGION') : Loc::getMessage('CITY')))) ?></option>
                            ...
                            <? if ($bHasChildSections): ?>
                                <div class="col-lg-6 col-md-4 col-sm-6">
                                    <select class="city">
                                        <option value="0"
                                                selected><?= Loc::getMessage('CHOISE_ITEM', array('#ITEM#' => Loc::getMessage('CITY'))) ?></option>
                                        <? foreach ($arAllSections['CHILD_SECTIONS'] as $arSection): ?>
                                            <option style="display:none;" disabled="disabled"
                                                    value="<?= $arSection['ID']; ?>"
                                                    data-parent_section="<?= $arSection['IBLOCK_SECTION_ID']; ?>"><?= $arSection['NAME']; ?></option>
                                        <? endforeach; ?>
                                    </select>
                                </div>
                            <? endif; ?>
                ...
                <div class="col-lg-<?= ($bHasSections ? 6 : 12); ?> col-md-12 info-row">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 ask_button text-right">
							<span>
								<span class="btn  btn-transparent-border-color white  animate-load" data-event="jqm"
                                      data-param-form_id="ASK"
                                      data-name="contacts"><?= Loc::getMessage('S_ASK_QUESTION'); ?></span>
							</span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="contacts-stores ">
                        ...
                        <div class="properties clearfix sb_border_block mx_contact_item">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pb-3"><span class="h3">Основной офис компании</span>
                                </div>
                        ...
                        <div class="properties clearfix sb_border_block">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 pb-3"><span class="h3">Отдел по обслуживанию оптовых и юр.лиц</span>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="property phone">
                                        <div class="title font_upper muted">Телефон</div>
                                        <div class="">
                                            <div class="value darken" itemprop="telephone"><a
                                                        title="звонок бесплатный по РФ" href="tel:+79293060372">+7 929
                                                    306 03-72</a></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="wrap">
                                ...
                                <? if ($bUseFeedback): ?>
                                    <div class="button_wrap">
										<span>
											<span class="btn  btn-transparent-border-color white  animate-load"
                                                  data-event="jqm" data-param-form_id="ASK" data-name="contacts">Написать сообщение</span>
										</span>
                                    </div>
                                <? endif; ?>
                            </div>
