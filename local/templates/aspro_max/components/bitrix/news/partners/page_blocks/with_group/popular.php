<?
$filterName = $arParams['FILTER_NAME'] ?: 'FILTER_POPULAR';
$GLOBALS[$filterName] = ['PROPERTY_IS_POPULAR_VALUE' => 'YES']?>
<div class="partners-popular">
	<?if (CMax::checkAjaxRequest()) $APPLICATION->RestartBuffer();?>
	<?$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"ONLY_IMG_MODE" => 'Y',//$arParams["ONLY_IMG_MODE"],
			"ONLY_AJAX_LINK" => 'Y',
			"MOBILE_SCROLLED" => 'Y',
			"NARROW" => 'Y',
			"MOBILE_BORDERED"	=>	$arParams["MOBILE_BORDERED"] ?? 'Y',
			"COLORED_IMG"	=>	$arParams["COLORED_IMG"] ?? 'Y',
			"IS_AJAX" => CMax::checkAjaxRequest()
		),
		$component
	);?>
	<?if (CMax::checkAjaxRequest()) die();?>
</div>