						...
						<div class="wrap clearfix">
							...
							<div class="body-info">
								...
								<div class="bottom">
									...
									<?if($bDelayColumn):?>
										<div class="delay-cell add">
											<a class="action_item to_basket" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>">
												<span class="icon" title="<?=GetMessage("SALE_ADD_TO_BASKET");?>"><?=CMax::showIconSvg("wish colored_theme_hover_text", SITE_TEMPLATE_PATH.'/images/svg/basket.svg', '', '', true, false);?></span>
											</a>
										</div>
									<?endif;?>
								</div>
	...
	<div class="foot clearfix">
		<div class="pull-left">
			<span class="wrap_remove_button basket_action">
				<?if($delayCount){?>
					<span class="colored_theme_hover_text remove_all_basket DelDelCanBuy cur" data-type="delay">
		...
		<?if($arResult["DELAY_PRICE"]["SUMM_FORMATED"]):?>
			<div class="total pull-right">
				<div class="item_title"><?=GetMessage("SALE_TOTAL");?></div>
				<div class="wrap_prices">
					<div class="price"><?=$arResult["DELAY_PRICE"]["SUMM_FORMATED"]?></div>
				</div>
			</div>
		<?endif;?>
	</div>
