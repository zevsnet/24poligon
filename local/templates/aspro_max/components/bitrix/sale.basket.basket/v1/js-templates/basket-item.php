...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}} {{SERVICES_CLASS}} {{WITH_SERVICES_CLASS}}"
	...
	{{^SHOW_RESTORE}}
	<tr class="basket-services-list-item-container {{SERVICES_CLASS}}" id="basket-services-item-{{ID}}" data-entity="basket-services-item" data-id="{{ID}}">
