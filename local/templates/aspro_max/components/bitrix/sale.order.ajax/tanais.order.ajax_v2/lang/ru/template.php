...
$MESS["SOA_SUM_SUMMARY"] = "#ITEMS_COUNT# #PRODUCT_TITLE#";
$MESS["SOA_SUM_SUMMARY_TEXT_1"] = "товар";
$MESS["SOA_SUM_SUMMARY_TEXT_2"] = "товара";
$MESS["SOA_SUM_SUMMARY_TEXT_3"] = "товаров";
...
$MESS["USE_COUPON_DEFAULT"] = "Введите промокод для скидки";
...
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_BTN"] = "Купить в 1 клик";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_TITLE"] = "Покупка в 1 клик";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_FIELD_NAME"] = "ФИО";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_FIELD_PHONE"] = "Телефон";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_FIELD_EMAIL"] = "E-mail";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_FIELD_COMMENT"] = "Комментарий";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_FIELD_CAPTCHA"] = "Введите каптчу";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_BTN"] = "Купить";
$MESS["TOTAL_BLOCK_BUY_ONE_CLICK_FORM_UNKNOWN_ERROR"] = "Произошла неизвестная ошибка";
$MESS["HEADER_BUTTONS_BACK_TO_CATALOG"] = "Вернуться к покупкам";
$MESS["HEADER_BUTTONS_TO_PRINT"] = "На печать";
$MESS["HEADER_BUTTONS_SAVE_TO_PDF"] = "Скачать в pdf";
$MESS["HEADER_LINE_TITLE"] = "Ваш заказ готов к оформлению";
$MESS["AUTOLOAD_LEGAL_INN_BTN"] = "Заполнить по ИНН";
?>
