...
$MESS["YM_GOALS_MAX_REGION"] = "Идентификатор цели при переходе из блока региона доставки по кнопке \"Далее\"";
$MESS["YM_GOALS_MAX_DELIVERY"] = "Идентификатор цели при переходе из блока доставки по кнопке \"Далее\"";
$MESS["YM_GOALS_MAX_PICKUP"] = "Идентификатор цели при переходе из блока пунктов самовывоза по кнопке \"Далее\"";
$MESS["YM_GOALS_MAX_PAY_SYSTEM"] = "Идентификатор цели при переходе из блока оплаты по кнопке \"Далее\"";
$MESS["YM_GOALS_MAX_PROPERTIES"] = "Идентификатор цели при переходе из блока свойств заказа по кнопке \"Далее\"";
$MESS["YM_GOALS_MAX_BASKET"] = "Идентификатор цели при переходе из блока списка товаров по кнопке \"Далее\"";
...
$MESS["MORE_DETAILS"] = "Кнопка раскрытия блока";
