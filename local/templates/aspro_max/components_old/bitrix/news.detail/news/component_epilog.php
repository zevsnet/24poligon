    ...
    <?elseif($code == 'gallery' && (is_array($templateData['GALLERY_BIG']) && count($templateData['GALLERY_BIG']))):?>
		...
		<div class="wraps galerys-block swipeignore  muted777 ordered-block with-title">
			...
			<div class="big-gallery-block "<?=($bShowSmallGallery ? ' style="display:none;"' : '');?> >
			    <div class="owl-carousel owl-theme owl-bg-nav short-nav" data-slider="content-detail-gallery__slider" data-plugin-options='{"items": "1", "autoplay" : false, "autoplayTimeout" : "1000", "smartSpeed":1000, "dots": true, "nav": true, "loop": false, "rewind":true, "index": true, "margin": 10}'>
