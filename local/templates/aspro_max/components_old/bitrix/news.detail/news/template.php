					...
					<?if($arBannerChar['GALLERY']):?>
						<div class="banner-char__gallery col-md-6 col-sm-6 col-xs-12 flexbox align-items-center swipeignore">
							<div class="banner-char__gallery-inner">
								<div class="owl-theme owl-bg-nav short-nav owl-dots owl-carousel owl-drag" data-plugin-options='{"items": "1", "autoplay" : false, "autoplayTimeout" : "1000", "smartSpeed":1000, "dots": true, "nav": true, "loop": false, "rewind":true, "margin": 10}'>
				...
				<div class="row flexbox">
					...
					<div class="gallery_wrap col-md-6 pull-right item">
						...
						<div class="big-gallery-block ">
						    <div class="owl-carousel owl-theme owl-bg-nav short-nav" data-slider="content-detail-gallery__slider" data-plugin-options='{"items": "1", "autoplay" : false, "autoplayTimeout" : "1000", "smartSpeed":1000, "dots": true, "nav": true, "loop": false, "rewind":true, "margin": 10}'>
...
//$bShowFormQuestion = ($arResult['DISPLAY_PROPERTIES']['FORM_QUESTION']['VALUE_XML_ID'] == 'YES');
?>
<?if($bShowFormOrder || $bShowFormQuestion):?>
		...
		<tr>
			...
			<td class="col-md-3 col-sm-4 col-xs-5 valign btns-col">
				<?if(isset($arResult['PROPERTIES']['PRICE']) && $arResult['PROPERTIES']['PRICE']['VALUE']):?>
					<div class="prices">
						<div class="price font_mlg font-bold darken"><?=$arResult['PROPERTIES']['PRICE']['VALUE'];?><?//=CPriority::FormatPriceShema($arItem['DISPLAY_PROPERTIES']['PRICE']['VALUE']);?></div>
