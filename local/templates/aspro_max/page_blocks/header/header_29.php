...
<?
global $arTheme, $arRegion, $bLongHeader2, $dopClass, $dopBodyClass, $bHeaderStickyMenuSm;
...
$bLongHeader2 = true;
$dopClass = 'wides_menu smalls big_header sticky_menu sm';
$dopBodyClass = ' sticky_menu';
$bHeaderStickyMenuSm = true;
?>
...
<div class="sidebar_menu">
   <div class="sidebar_menu_inner">
      ...
      <div class="menu-wrapper">
         <?$APPLICATION->IncludeComponent("bitrix:menu", "left_catalog_icons", array(
            "ROOT_MENU_TYPE" => "left",
            "MENU_CACHE_TYPE" => "A",
