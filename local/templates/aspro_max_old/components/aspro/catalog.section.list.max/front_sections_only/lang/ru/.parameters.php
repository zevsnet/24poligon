...
$MESS ['VIEW_TYPE'] = "Тип отображения";
$MESS ['SHOW_ICONS_NAME'] = "Отображать иконку раздела";
...
$MESS ['SHOW_SUBSECTIONS_NAME'] = "Отображать подразделы";
$MESS ['SCROLL_SUBSECTIONS_NAME'] = "Отображать подразделы при наведении";
?>