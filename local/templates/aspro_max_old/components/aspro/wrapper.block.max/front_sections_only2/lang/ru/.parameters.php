...
$MESS ['T_TITLE_BLOCK_ALL'] = "Заголовок на все элементы";
$MESS ['BLOCK_NAME'] = "Новости";
$MESS ['BLOCK_ALL_NAME'] = "Все новости";
$MESS ['T_ALL_URL'] = "Ссылка на все элементы";
...
$MESS ['CP_BCS_COUNT_ELEMENTS'] = "Показывать количество элементов в разделе";
...
$MESS ['NO_MARGIN_NAME'] = "Не использовать отступ между блоками";
...
$MESS["T_SHAPE_PICTURES"] = "Формат картинок";
$MESS['T_SHAPE_PICTURES_SQUARE'] = 'Квадратные';
$MESS['T_SHAPE_PICTURES_ROUND'] = 'Круглые';
$MESS["T_LIST_YES"] = "Да";
$MESS["T_LIST_NO"] = "Нет";
$MESS['V_FROM_THEME'] = 'Из настроек решения';
$MESS['T_LAST_LINK_IN_SLIDER'] = 'Ссылка на каталог в конце слайдера';
$MESS['V_ELEMENTS_COUNT'] = '#COUNT# элементов';
$MESS['T_SLIDER_ELEMENTS_COUNT'] = 'В строке';
?>