...
if ($arParams["USE_COMPARE_GROUP"] === "Y") {
    if ($arSectionsIDs) {
        $arResult['SECTIONS'] = CMaxCache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => CMaxCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'GROUP' => array('ID'), 'MULTI' => 'N')), array('ID' => $arSectionsIDs, 'ACTIVE' => 'Y'), false, array("ID", "NAME", "IBLOCK_ID", "SECTION_PAGE_URL"));
    }
	...
	if (count($arResult['ITEMS']) === 1) {
		$arResult['SECTIONS'][0]['SECTION_PAGE_URL'] = CMaxCache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => CMaxCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), array(), 'MULTI' => 'N')), array('ID' => $arSectionsIDs, 'ACTIVE' => 'Y'), false, array("SECTION_PAGE_URL"))['SECTION_PAGE_URL'] ?: CMax::GetFrontParametrValue('CATALOG_PAGE_URL');
	}
}
