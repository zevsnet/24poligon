...
if(!$arResult['USER_ID'] && !isset($arParams['GUEST_ACCESS'])):?>
	...
	<div class="row guest-block">
		...
		<div class="col-md-12 col-sm-12" id="catalog-subscriber-auth-form" style="<?=$authStyle?>">
			<?$APPLICATION->IncludeComponent(
				...
				Array(
					...
					"FORGOT_PASSWORD_URL" => SITE_DIR."auth/forgot_password/",
...
if (!empty($arResult['ITEMS']))
{
	...
	?>
	<div class="subsribe-page bx_item_list_you_looked_horizontal col<?=$arParams['LINE_ELEMENT_COUNT'];?>">
		<h3><?=Loc::getMessage('CPSL_SUBSCRIBE_TITLE')?></h3>
...
<!--		</div>-->
	...
	<?if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) // Simple Product
	{
		...
		<div class="bx_catalog_item_controls">
			...
			<div>
				<a id="<?=$arItemIDs['SUBSCRIBE_DELETE_LINK'];?>" class="btn btn-default white" href="javascript:void(0)">
