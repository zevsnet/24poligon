				...
				<div class="bx_filter_parameters">
					...
					foreach($arResult["ITEMS"] as $key => $arItem){
					    if (isset($arItem["ASPRO_FILTER_SORT"]) && $arItem["VALUES"]) {
							...
							?>
							<div class="bx_filter_parameters_box bx_sort_filter <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code="<?=strtolower($arItem["CODE"]);?>" data-prop_inline="<?=($arItem['IS_PROP_INLINE'] ? 'prop_inline' : '')?>" data-property_id="<?=$arItem["ID"]?>">
					...
					foreach($arResult["ITEMS"] as $key=>$arItem)
					{
						...
						$isFilter=true;
						?>
						<div class="bx_filter_parameters_box prop_type_<?=$arItem["PROPERTY_TYPE"];?><?=(isset($arItem['PROPERTY_SET']) && $arItem['PROPERTY_SET'] == 'Y' ? ' set' : '');?>" data-prop_code="<?=strtolower($arItem["CODE"]);?>" data-prop_inline="<?=($arItem['IS_PROP_INLINE'] ? 'prop_inline' : '')?>" data-property_id="<?=$arItem["ID"]?>">
							<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
