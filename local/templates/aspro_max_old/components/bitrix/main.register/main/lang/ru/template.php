...
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "На ваш e-mail отправлен запрос на подтверждение регистрации. Пожалуйста, следуйте инструкциям из письма, чтобы авторизоваться на сайте.";
