						...
						<div class="tab-pane">
							...
							<div class="items <?=$bCarousel ? "swipeignore mobile-overflow mobile-margin-16 mobile-compact" : ""?>">
								<?foreach($arSection['ITEMS'] as $i => $arItem):?>
									...
									?>
									<div class="item bordered box-shadow rounded3 colored_theme_hover_bg-block <?=$bCarousel ? "item-width-261" : ""?>">
										<div class="wrap clearfix" id="<?=$this->GetEditAreaId($arItem['ID']);?> <?=$bCarousel ? "item" : ""?>">
											<?if($imageSrc):?>
