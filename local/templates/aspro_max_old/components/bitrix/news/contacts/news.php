		...
		<div class="contacts maxwidth-theme" itemscope itemtype="http://schema.org/Organization">
			<div class="row">
				...
				<?if($bHasSections):?>
					...
					<? \Aspro\Max\Functions\Extensions::init('ikSelect'); ?>
				<?endif;?>
...
<div class="ajax_items">
	...
	<?if($arItems):?>
		...
		<?$APPLICATION->IncludeComponent(
			...
			"contacts",
			Array(
				"COUNT_IN_LINE" => $arParams["COUNT_IN_LINE"] ?? '3',
				...
				"DISPLAY_PANEL"	=>	$arParams["DISPLAY_PANEL"] ?? 'N',
				...
				"GROUP_PERMISSIONS"	=>	$arParams["GROUP_PERMISSIONS"] ?? 'N',
