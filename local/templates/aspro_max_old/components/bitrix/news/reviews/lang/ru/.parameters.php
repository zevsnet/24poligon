...
$MESS["STAFF_IBLOCK_ID_NAME"] = "Инфоблок сотрудников для ответа";

$MESS["SHOW_ADD_REVIEW_BUTTON_NAME"] = "Показывать кнопку добавления отзыва";
$MESS["ADD_REVIEW_BUTTON_NAME"] = "Надпись кнопки добавить отзыв";
