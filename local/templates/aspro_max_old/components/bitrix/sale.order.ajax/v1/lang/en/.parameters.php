...
$MESS["YM_GOALS_MAX_REGION"] = "Goal ID for transfer from delivery area to 'Next' button";
$MESS["YM_GOALS_MAX_DELIVERY"] = "Goal ID for transfer from delivery to 'Next' button";
$MESS["YM_GOALS_MAX_PICKUP"] = "Goal ID for transfer from pick-up locations to 'Next' button";
$MESS["YM_GOALS_MAX_PAY_SYSTEM"] = "Goal ID for transfer from payment to 'Next' button";
$MESS["YM_GOALS_MAX_PROPERTIES"] = "Goal ID for transfer from product properties to 'Next' button";
$MESS["YM_GOALS_MAX_BASKET"] = "Goal ID for transfer from shopping cart to 'Next' button";
...
$MESS["MORE_DETAILS"] = "Block deployment button";
