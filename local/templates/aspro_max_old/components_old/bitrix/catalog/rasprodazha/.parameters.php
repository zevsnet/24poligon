...
$arTemplateParametersParts[] = array_merge($arPageBlocksParams,array(
	...
	"SORT_BUTTONS" => Array(
		...
		"TYPE" => "LIST",
		"VALUES" => array("SORT"=>GetMessage("SORT_BUTTONS_SORT"),"POPULARITY"=>GetMessage("SORT_BUTTONS_POPULARITY"), "NAME"=>GetMessage("SORT_BUTTONS_NAME"), "PRICE"=>GetMessage("SORT_BUTTONS_PRICE"), "QUANTITY"=>GetMessage("SORT_BUTTONS_QUANTITY")),
...
$arTemplateParametersParts[] = array(
	'DETAIL_BLOCKS_TAB_ORDER' => array(
		...
		'DEFAULT' => 'desc,char,buy,payment,delivery,video,stores,reviews,custom_tab'
	)
);
$arTemplateParametersParts[] = array(
	'DETAIL_BLOCKS_ALL_ORDER' => array(
		...
		'DEFAULT' => 'complect,nabor,offers,desc,char,buy,payment,delivery,video,stores,custom_tab,services,news,reviews,blog,staff,vacancy,gifts,goods'
	)
);
