	...
	<div class="middle">
		...
		if($arItems)
		{
			...
			if($arAllSections)
			{
				...
				$arSections = CMaxCache::CIBlockSection_GetList(array('CACHE' => array("MULTI" =>"N", "GROUP" => "ID", "TAG" => CMaxCache::GetIBlockCacheTag($catalogIBlockID))), array("ID" => $arSectionsID, "IBLOCK_ID" => $catalogIBlockID), false, array("ID", "IBLOCK_ID", "NAME"));
			}
			?>
