...
$arTemplateParameters = array_merge($arPageBlocksParams, array(
	...
	"IBLOCK_LINK_SALE_ID" => Array( 
            "NAME" => GetMessage("IBLOCK_LINK_SALE_NAME"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "", 
        ),
	"BLOCK_SALE_NAME" => Array( 
            "NAME" => GetMessage("BLOCK_SALE_NAME_TITLE"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "",
        ),
...
$arTemplateParameters['DETAIL_BLOCKS_ALL_ORDER'] = array(  
	...
	'DEFAULT' => 'tizers,desc,docs,char,goods,services,blog,vacancy,news,sale,form_order,projects,reviews,video,gallery,brands,landings,staff,comments,partners'  
);
