	...
	<div class="ordered-block gifts">
		<div class="bx_item_list_you_looked_horizontal detail <? echo $templateData['TEMPLATE_CLASS']; ?>">
			<div class="common_product wrapper_block s_<?=$injectId;?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>">
				...
				<div class="all_wrapp">
					<div class="content_inner tab owl-carousel owl-theme owl-bg-nav short-nav hidden-dots catalog_block" data-plugin-options='{"nav": true, "autoplay" : false, "autoplayTimeout" : "1000", "smartSpeed":1000, <?=(count($arResult["ITEMS"]) > 4 ? "\"loop\": true," : "")?> "responsiveClass": true, "responsive":{"0":{"items": 1},"600":{"items": 2},"768":{"items": 3},"992":{"items": 4}}}'>
								...
								<div class="catalog_item item visible main_item_wrapper" id="<?=$arItem["strMainID"];?>">
									<div class="inner_wrap TYPE_2">
										<div class="image_wrapper_block">
											...
											<?\Aspro\Functions\CAsproMaxItem::showDelayCompareBtn($arParams, $arItem, $arAddToBasketData, $totalCount, $bUseSkuProps, 'block', true, true, '_small', $currentSKUID, $currentSKUIBlock);?>
