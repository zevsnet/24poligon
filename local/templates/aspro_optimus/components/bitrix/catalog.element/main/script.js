...
{
	console.log(this.config.mainPictureMode)
...
window.JCCatalogElement.prototype.SetSliderPict = function(obj, slider, config)
{
	var container=$('.wrapp_thumbs'),
		...
		for(var i in slider){
			...
			'<span class="cnt"><img border="0" src="'+slider[i].THUMB.src+'" /></span>'+
			'</li>';
		}
		slideHtml+='</ul>';
...
window.JCCatalogElement.prototype.SetSliderPictMobile = function(obj, slider)
{
	...
	if(!slider.length){
		slideHtml+='<li data-value="">'+
			'<span rel="item_slider" class="fancy" ><img border="0" src="'+obj.NO_PHOTO.SRC+'"/></span>'+
			'</li>';
	}else{
		for(var i in slider){
			slideHtml+='<li data-value="'+obj.ID+'_'+slider[i].ID+'">'+
			'<a href="'+slider[i].BIG.src+'" rel="item_slider" class="fancy" ><img border="0" src="'+slider[i].SMALL.src+'"  /></a>'+
			'</li>';
		}
	}
	slideHtml+='</ul>';
