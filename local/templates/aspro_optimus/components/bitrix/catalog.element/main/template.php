                            ...
                            <div class="like_icons iblock">
                                <? if ($arParams["DISPLAY_WISH_BUTTONS"] != "N"): ?>
                                    ...
                                    <? elseif ($arResult["OFFERS"] && $arParams["TYPE_SKU"] === 'TYPE_1' && !empty($arResult['OFFERS_PROP'])): ?>
                                        <div class="wish_item text " data-item=""
                                ...
                                <? if ($arParams["DISPLAY_COMPARE"] == "Y"): ?>
                                    <? if (!$arResult["OFFERS"]): ?>
                                        <div data-item="<?= $arResult["ID"] ?>"
                                            ...
                                            <span class="value"
                                                  title="<?= GetMessage('CT_BCE_CATALOG_COMPARE') ?>"><i></i></span>
                                            <span class="value added"
                                ...
                                <a href="<?= ($viewImgType == "POPUP" ? $arFirstPhoto["BIG"]["src"] : "javascript:void(0)"); ?>"
                                   class="<?= ($viewImgType == "POPUP" ? "popup_link" : "line_link"); ?>">
                                    <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                         data-zoom-image="<?=$viewImgType == "POPUP" ? $arFirstPhoto["BIG"]["src"] : ""; ?>"
                                         src="<?= $arFirstPhoto['SMALL']['src']; ?>" <?= ($viewImgType == "MAGNIFIER" ? 'data-large=""' : ""); ?>
                                         alt="<?= $alt; ?>">
                                </a>
                            <? } else { ?>
                                <a href="javascript:void(0)" class="">
                                    <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                         src="<?= $arFirstPhoto['SRC']; ?>" alt="<?= $arResult["NAME"]; ?>">
                                </a>
                            <? } ?>
                        </div>
                    <? } else {
                                ...
                                foreach ($arResult["MORE_PHOTO"] as $i => $arImage) {
                                    ...
                                    <li id="photo-<?= $i ?>" <?= (!$i ? 'class="current"' : 'style="display: none;"') ?>>
                                        ...
                                        if (!$isEmpty) {
                                            ...
                                            >
                                                <img src="<?= $arImage["SMALL"]["src"] ?>" <?= ($viewImgType == "MAGNIFIER" ? "class='zoom_picture'" : ""); ?> <?= ($viewImgType == "MAGNIFIER" ? 'data-large="' . $arImage["BIG"]["src"] . '"' : ""); ?>
                                                     alt="<?= $alt; ?>"/>
                                            </a>
                                            <?
                                        } else {
                                            ?>
                                            <img src="<?= $arImage["SRC"] ?>" alt="<?= $alt; ?>"/>
                                            <?
                                        } ?>
                                    </li>
                                    <?
                    ...
                    <div class="wrapp_thumbs">
                        <div class="thumbs flexslider"
                            ...
                            <ul class="slides_block" id="thumbs">
                                <? foreach ($arResult["MORE_PHOTO"] as $i => $arImage): ?>
                                    <li <?= (!$i ? 'class="current"' : '') ?>>
                                    <span><img src="<?= $arImage["THUMB"]["src"] ?>" alt="<?= $arImage["ALT"]; ?>"
                                        /></span>
                                    </li>
                                <? endforeach; ?>
                            </ul>
                        ...
                        <? if (strlen($arResult["PREVIEW_TEXT"])): ?>
                            ...
                            <? if (strlen($arResult["DETAIL_TEXT"])): ?>
                                <div class="more_block icons_fa color_link">
                                    <span><?= GetMessage('MORE_TEXT_BOTTOM'); ?></span></div>
                            <? endif; ?>
                        <? endif; ?>
                    </div>
                <? } ?>
                        ...
                        <div class="cost prices clearfix">
                            <? if (count($arResult["OFFERS"]) > 0) {
                                ...
                                if ($arParams["SHOW_OLD_PRICE"] == "Y") {
                                    ...
                                    <? if ($arResult['PROPERTIES']['STARAYA_TSENA'] && $minPrice["DISCOUNT_DIFF"] == false): ?>
                                        <? if ($arResult['PROPERTIES']['STARAYA_TSENA']['VALUE'] !== '') { ?>
                                            <div class="price discount">
                                                <span><?= CurrencyFormat($arResult['PROPERTIES']['STARAYA_TSENA']['VALUE'], 'RUB');; ?></span>
                                            </div>
                                        <? } ?>
                                    <? else: ?>
                                        <div class="price discount">
                            ...
                            <? } else { ?>
                                ...
                                $arMinPrice = array_pop($arResult["PRICES"]);
                                foreach ($arResult["PRICES"] as $key => $arPrice) {
                                    if ($arMinPrice['PRICE'] > $arPrice['PRICE']) {
                                        $arMinPrice = $arResult["PRICES"][$key];
                                    }
                                }
                                $arResult["PRICES"] = [];
                                $arResult["PRICES"][$arMinPrice['NAME']] = $arMinPrice;
                        ...
                        <? if (!$arResult["OFFERS"]): ?>
                            ...
                            <div class="counter_wrapp">
                                ...
                                <div id="<? echo $arItemIDs["ALL_ITEM_IDS"]['BASKET_ACTIONS']; ?>"
                                     class="button_block <?= (($arAddToBasketData["ACTION"] == "ORDER" /*&& !$arResult["CAN_BUY"]*/) || !$arResult["CAN_BUY"] || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] || ($arAddToBasketData["ACTION"] == "SUBSCRIBE" && $arResult["CATALOG_SUBSCRIBE"] == "Y") ? "wide" : ""); ?>">
                                    <!--noindex-->
                                ...
                                <div class="image">
                                    <a href="<?= $arSetItem["DETAIL_PAGE_URL"] ?>">
                                        <? if ($arSetItem["PREVIEW_PICTURE"]): ?>
                                            <? $img = \SB\Site\General::getarWaterMark(140, $arSetItem["PREVIEW_PICTURE"]["ID"]); ?>
                                            <img src="<?= $img["src"] ?>" alt="<?= $arSetItem["NAME"]; ?>"
                                                 title="<?= $arSetItem["NAME"]; ?>"/>
                                        <? elseif ($arSetItem["DETAIL_PICTURE"]): ?>
                                            <? $img = \SB\Site\General::getarWaterMark(140, $arSetItem["DETAIL_PICTURE"]["ID"]); ?>
                                            <img src="<?= $img["src"] ?>" alt="<?= $arSetItem["NAME"]; ?>"
                                                 title="<?= $arSetItem["NAME"]; ?>"/>
                                        <? else: ?>
                                ...
                                foreach ($arResult["SKU_PROPERTIES"] as $key => $arProp) {
                                    ...
                                    if (!$arProp["IS_EMPTY"]):?>
                                        ...
                                        <span <?
                                            ...
                                            if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y"):?>
                                                <div class="hint"><span class="icon"><i>?</i></span><div
                                    ...
                                    if ($showSkUImages):?>
                                        ...
                                        <td class="property">
                                            ...
                                            if ($imgPreviewID || $imgDetailID) {
                                                $arImgPreview = CFile::ResizeImageGet($imgPreviewID ?: $imgDetailID, array('width' => 50, 'height' => 50), BX_RESIZE_IMAGE_PROPORTIONAL, true);
    ...
    <div itemscope itemtype="http://schema.org/Product" style="display: none">
        ...
        <? if ($count_offers > 0): ?>
            <div itemprop="offers" itemscope itemtype="http://schema.org/AggregateOffer">
                ...
                <span itemprop="priceCurrency"
                      content="<?= $arResult["MIN_PRICE"]["CURRENCY"]; ?>"><?= $arResult["MIN_PRICE"]["CURRENCY"]; ?></span>
                <? foreach ($arResult["OFFERS"] as $arOffer) { ?>
        ...
        <? else: ?>
            <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                <? foreach ($arResult["PRICES"] as $key => $arPrice) { ?>
                    <span itemprop="priceCurrency"
                          content="<?= $arPrice["CURRENCY"]; ?>"><?= $arPrice["CURRENCY"]; ?></span>
                    <? if ($arPrice["CAN_ACCESS"]) { ?>
                        <? if ($arPrice["VALUE"] > $arPrice["DISCOUNT_VALUE"]) { ?>
