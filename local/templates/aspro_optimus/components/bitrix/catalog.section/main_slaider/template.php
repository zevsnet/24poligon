...
<? if (count($arResult["ITEMS"]) >= 1) { ?>
    <div class="top_wrapper swiper-container">
        <div class="swiper-wrapper catalog_block items">
            <? foreach ($arResult["ITEMS"] as $arItem) { ?>
                <div class="swiper-slide catalog_item_wrapp item">
                            ...
                            <div class="image_wrapper_block">
                                ...
                                <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="thumb">
                                    ...
                                    <? if (!empty($arItem["PREVIEW_PICTURE"])): ?>
                                        <img class="noborder" src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>"
                                             alt="<?= $a_alt; ?>" title="<?= $a_title; ?>"/>
                                    <? elseif (!empty($arItem["DETAIL_PICTURE"])): ?>
                                        <? $img = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array("width" => 170, "height" => 170), BX_RESIZE_IMAGE_PROPORTIONAL, true); ?>
                                        <img class="noborder" src="<?= $img["src"] ?>" alt="<?= $a_alt; ?>"
                                             title="<?= $a_title; ?>"/>
                                    <? else: ?>
                                        <img class="noborder" src="<?= SITE_TEMPLATE_PATH ?>/images/no_photo_medium.png"
                                             alt="<?= $a_alt; ?>" title="<?= $a_title; ?>"/>
                                    <? endif; ?>
                                </a>
                            </div>
                                    ...
                                    <div class="counter_wrapp">
                                        <div class="button_block">
                                            ...
                                            <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>"
                                               class="button basket read_more"><?= GetMessage("CATALOG_READ_MORE"); ?></a>
                                            <!--/noindex-->
                                        </div>
                                    </div>
                                </div>
