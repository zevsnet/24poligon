...
if($arResult["ITEMS"]){?>
	<div class="bx_filter bx_filter_vertical">
		<div class="bx_filter_section">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter rows_block">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if(isset($arItem["PRICE"])):
						if ($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"] <= 0)
							continue;
						?>
						<div class="bx_filter_parameters_box active item_block col-12">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					$isFilter=true;
					?>
					<div class="bx_filter_parameters_box <?=$class;?> item_block col-100" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code=<?=strtolower($arItem["CODE"]);?>
