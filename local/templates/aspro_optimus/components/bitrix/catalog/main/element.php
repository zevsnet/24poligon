...
$tmpNewStrMeta = \SB\Site\General::getTitleNew('title');
$arAdditionalData['WINDOW_TITLE'] = htmlspecialcharsback($tmpNewStrMeta);
        ...
        <div class="top_blocks">
            <ul class="tabs">
                ...
                foreach ($arTab as $code => $title):?>
                    <li data-code="<?= $code ?>" <?= ($code == "RECOMENDATION" ? "style='display:none;'" : ""); ?> <?= ($i == 1 ? "class='cur'" : "") ?>>
                        <span><?= $title; ?></span></li>
                    <? $i++; ?>
                <? endforeach; ?>
                <li class="stretch"></li>
