...
if ($section) {
    ...
    //$APPLICATION->ShowProperty("idex_seo_text",'');
    ...
    while ($arRes = $rsData->Fetch()) {
        $arSection["DESCRIPTION"] = $arRes['SEO_TEXT'];

        //$arSection["DESCRIPTION_MINI"] = $arRes['SEO_TEXT'];
        $arSection["DESCRIPTION"] = "<div class=\"block\">
  <div class=\"sb_seo_text\" tabindex=\"0\">".$arRes['SEO_TEXT']."</div><button class=\"sb_detail_seo_text button transparent\">Подробнее</button></div>";
        break;
    }
...
<? } ?>
<div class="right_block1 clearfix catalog <?= strtolower($TEMPLATE_OPTIONS["TYPE_VIEW_FILTER"]["CURRENT_VALUE"]); ?>"
     id="right_block_ajax">
