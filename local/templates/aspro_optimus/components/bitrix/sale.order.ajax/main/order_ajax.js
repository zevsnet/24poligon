...
*/
			if (currentStore.SCHEDULE)
				html += BX.message('SOA_PICKUP_WORK') + ': ' + BX.util.htmlspecialchars(currentStore.SCHEDULE) ;
/*
			...
			storeNode = BX.create('DIV', {
				...
				children: [
					BX.create('DIV', {
						...
						children: [BX.util.htmlspecialchars(currentStore.ADDRESS)+ ' <span style="color:#ab2640;">('+BX.util.htmlspecialchars(currentStore.DESCRIPTION)+')</span>' ]
					}),
					BX.create('DIV', {
