...
<meta name="cmsmagazine" content="1b3e5f743c8d405348ec29a465a2f3fc" />
        ...
        <? $APPLICATION->AddHeadString('<script>BX.message(' . CUtil::PhpToJSObject($MESS, false) . ')</script>',
            true); ?>
        <?
        ...
        <link href='<?= CMain::IsHTTPS() ? 'https' : 'http' ?>://fonts.googleapis.com/css?family=Ubuntu:400,500,700,400italic&subset=latin,cyrillic'
              rel='stylesheet' type='text/css'>

        <meta name="yandex-verification" content="e2ee357f793970dc"/>
        <script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://vk.com/js/api/openapi.js?160",t.onload=function(){VK.Retargeting.Init("VK-RTRG-347215-fVHvK"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-347215-fVHvK" style="position:fixed; left:-999px;" alt=""/></noscript>
    </head>
<body id="main">
<div id="panel"><? $APPLICATION->ShowPanel(); ?></div>
 <!-- Swiper -->
     <?$arElementTopSliderMini = \SB\Site\Bitrix\SBElement::getElement(['IBLOCK_ID'=>\SB\Site\Variables::IBLOCK_ID_SLIDER_TOP_MINI,'ACTIVE'=>'Y']);?>
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <?foreach ($arElementTopSliderMini as $sbItem):?>
                <div class="swiper-slide"><?=$sbItem['~PREVIEW_TEXT']?></div>
            <?endforeach;?>
        </div>
...
<? $APPLICATION->IncludeComponent("aspro:theme.optimus", ".default", array("COMPONENT_TEMPLATE" => ".default"),
    false); ?>
                    ...
                    <div class="top_inner">
                        ...
                        <div class="phones">
                            <div class="phone_block">
                                ...
                                <!--										</span>-->
                                <span class="order_wrap_btn"><a class="sb_link_help"
                                                                href="/contacts/">Контакты</a></span>
                                <!--                                <span class="order_wrap_btn"><a class="sb_link_help" href="/sale/">Акции</a></span>-->
                            </div>
        ...
        <header id="header">
            <div class="wrapper_inner">
                ...
                <table class="middle-h-row">
                    <tr>
                        <td class="logo_wrapp">
                            <div class="logo nofill_<?= strtolower(\Bitrix\Main\Config\Option::get('aspro.optimus',
                                'NO_LOGO_BG', 'N')); ?>">
                                <? COptimus::ShowLogo(); ?>
                            </div>
                        </td>
                                ...
                                <div class="middle_phone">
                                    <div class="phones">
												<span class="phone_wrap">
													...
													<span class="order_wrap_btn">
														<span onclick="yaCounter43218779.reachGoal('perezvoni'); return true;"
                                                              class="callback_btn"><?= GetMessage("CALLBACK") ?></span>
													</span>
												</span>
                                    </div>
                                </div>
...
<div class="wrapper_inner <?= (COptimus::IsMainPage() ? "front" : ""); ?> <?= ((COptimus::IsOrderPage() || COptimus::IsBasketPage() || General::IsOrderNewPage()) ? "wide_page" : ""); ?>">
