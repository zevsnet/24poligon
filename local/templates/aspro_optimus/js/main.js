...
if (!funcDefined("setStatusButton")) {
    function setStatusButton() {
        $.ajax({
            url: arOptimusOptions.SITE_DIR + "ajax/getAjaxBasket.php", type: "POST", success: function (data) {
                if (data.BASKET) {
        ...
        if (name == "order-popup-call") {
            ...
            if (name == "order-button") {
                ...
                if (name == "to-order" && selector) {
                    ...
                    if (name == "services" && selector) {
                        $(".services_frame").find('[data-sid="SERVICE"]').val($(selector).attr("data-title"));
                    } else {
                        if (name == "resume" && selector) {
    ...
    function checkCounters(name) {
        if (typeof name !== "undefined") {
            if (name == "google" && (arOptimusOptions.COUNTERS["GOOGLE_ECOMERCE"] == "Y" && arOptimusOptions.COUNTERS["GOOGLE_COUNTER"] > 0)) {
                ...
                if (name == "yandex" && (arOptimusOptions.COUNTERS["YANDEX_ECOMERCE"] == "Y" && arOptimusOptions.COUNTERS["YANDEX_COUNTER"] > 0)) {
                    return true;
                } else {
                    return false;
                }
            ...
            if ((arOptimusOptions.COUNTERS["YANDEX_ECOMERCE"] == "Y" && arOptimusOptions.COUNTERS["YANDEX_COUNTER"] > 0) || (arOptimusOptions.COUNTERS["GOOGLE_ECOMERCE"] == "Y" && arOptimusOptions.COUNTERS["GOOGLE_COUNTER"] > 0)) {
                return true;
            } else {
                return false;
            }
                    ...
                    if (products) {
                        waitLayer(100, function () {
                            dataLayer.push({
                                ...
                                ecommerce: {actionField: {step: step, option: option}, products: products},
                            });
                        });
                    }
                }
...
checkScrollToTop = function () {
    var bottom = 55, scrollVal = $(window).scrollTop(), windowHeight = $(window).height(),
...
InitZoomPict = function () {
    if ($(".zoom_picture").length) {
        ...
        var zoomer = $(".zoom_picture"), options, defaults = {
            zoomrange: [1, 12],
            zoomstart: 4,
...
SetActualBasketFlyCounters = function () {
    if (arBasketAsproCounters.DEFAULT == true) {
        $.ajax({
            url: arOptimusOptions.SITE_DIR + "ajax/basket_fly.php", type: "post", success: function (html) {
...
$(document).ready(function () {
    ...
    $("body").on("click", ".captcha_reload", function (e) {
        ...
        e.preventDefault();
        $.ajax({url: arOptimusOptions.SITE_DIR + "ajax/captcha.php"}).done(function (text) {
    ...
    $(document).on("click", ".to-cart:not(.read_more)", function (e) {
        ...
        var tmp_props = $(this).data("props"), props = "", part_props = "", add_props = "N", fill_prop = {},
            iblockid = $(this).data("iblockid"), offer = $(this).data("offers"), rid = "", basket_props = "",
    ...
    $(document).on("click", ".to-subscribe", function (e) {
        ...
        if ($(this).is(".auth")) {
            ...
            $.get(arOptimusOptions.SITE_DIR + "ajax/item.php?item=" + item + "&subscribe_item=Y", $.proxy(function (data) {
                $(".wish_item[data-item=" + item + "]").removeClass("added");
    ...
    $(document).on("click", ".wish_item", function (e) {
        e.preventDefault();
        var val = $(this).attr("data-quantity"), offer = $(this).data("offers"), iblockid = $(this).data("iblock"),
            tmp_props = $(this).data("props"), props = "", item = $(this).data("item");
    ...
    $(document).on("click", ".compare_item", function (e) {
        ...
        $.get(arOptimusOptions.SITE_DIR + "ajax/item.php?item=" + item + "&compare_item=Y&iblock_id=" + iblockID, $.proxy(function (data) {
            getActualBasket(iblockID);
    ...
    $(document).on("click", ".ajax_load_btn", function () {
        ...
        th.addClass("loading");
        $.ajax({
            url: url, data: {ajax_get: "Y"}, success: function (html) {
    ...
    $(document).on("click", ".bx_compare .tabs-head li", function () {
        ...
        $.ajax({
            url: url, data: {ajax_action: "Y"}, success: function (html) {
                history.pushState(null, null, url);
    ...
    $(".btn.btn-add").on("click", function () {
        $.ajax({
            type: "GET", url: arOptimusOptions.SITE_DIR + "ajax/clearBasket.php", success: function (data) {
            }
        });
    });
...
if (!funcDefined("checkMinPrice")) {
    checkMinPrice = function () {
        if (arOptimusOptions.PAGES["BASKET_PAGE"]) {
            var summ_raw = $("#allSum_FORMATED").text().replace(/[^0-9\.]/g, ""), summ = parseFloat(summ_raw);
