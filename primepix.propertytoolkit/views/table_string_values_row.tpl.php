<tr id="<?=$arProp['ID']?>">
	...
	<td class="-edit-list-td edit-td" data-in-progress="false" data-type="value" data-id="<?=$arProp['ID']?>"><span><?=trim($arProp["VALUE"])?></span><input name="value" class="edit-input -edit-input" value="<?=$arProp["VALUE"]?>"></td>
